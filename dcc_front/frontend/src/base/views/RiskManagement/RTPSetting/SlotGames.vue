      ...
      <template #default="{ show }">
        <form v-show="show">
          <div class="flex flex-wrap items-center">
            ...
            <FormSlotRoomTypeListDropdown v-model="formInput.roomType" class="mb-1 w-full md:w-3/12" />
          </div>
            ...
            <div class="tbl-container">
              <table class="tbl tbl-hover">
                ...
                <tbody class="text-slate-500">
                  ...
                  <template v-else>
                    <tr v-for="(record, index) in currentRecords" :key="`slotRecord_${index}`">
...
import FormSlotRoomTypeListDropdown from '@/base/components/Form/Dropdown/FormSlotRoomTypeListDropdown.vue'
