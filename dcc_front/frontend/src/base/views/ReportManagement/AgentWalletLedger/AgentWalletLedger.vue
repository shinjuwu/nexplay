            ...
            <table class="tbl tbl-hover">
              <thead>
                <tr>
                  ...
                  <PageTableSortableTh column="beforeScore" :is-sort-icon-active="isSortIconActive" @sorting="sorting">
                  ...
                  <PageTableSortableTh column="afterScore" :is-sort-icon-active="isSortIconActive" @sorting="sorting">
...
import { useAgentWalletLedger } from '@/base/composable/reportManagement/agentWalletLedger/useAgentWalletLedger'
...
const { t } = useI18n()
const { records, totalUpScore, totalDownScore, formInput, tableInput, searchRecords, downloadRecords } =
  useAgentWalletLedger()
</script>
