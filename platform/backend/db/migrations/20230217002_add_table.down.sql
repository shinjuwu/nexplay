...
DELETE FROM "public"."permission_list" WHERE feature_code IN (100270, 100271, 100272, 100273, 100274);
...
FROM (
    ...
    WHERE "ag2"."agent_id" = -1 AND "ag2ple"::int NOT IN (100270, 100271, 100272, 100273, 100274)
    GROUP BY "ag2"."id"
) AS "ag3"
WHERE "ag1"."id" = "ag3"."id";
