...
const (
	...
	CasinoHandle_Path    = "/channel/casinoHandle"
)
...
const (
	...
	Response_TimeIntervalSetting_Error        = 1023 // 超過設定間隔時間
	Response_InsufficientUserBalance_Error    = 1024 // 用戶餘額不足
	Response_GameNotOpen_Error                = 1025 // 遊戲未開啟
	Response_GameServeDepositTypeFailed_Error = 1026 // 遊戲上/下分類型錯誤
	Response_OrderIdNotFoundFailed_Error      = 1027 // 無此訂單編號
...
const (
	// request code
	CasinoHandle_GameLogin = iota // 登入遊戲
	CasinoHandle_Register         // 註冊帳號
	CasinoHandle_Credit           // 充值

	CasinoHandle_Max

	Casino_Agent_IdStr = "4"
	Casino_Agent_Id    = 4
)
