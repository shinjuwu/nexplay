...
ALTER TABLE "public"."user_play_log_prawncrab" 
  ...
  ADD CONSTRAINT "play_log_prawncrab_pkey" PRIMARY KEY ("lognumber", "agent_id", "user_id", "game_id", "room_type", "desk_id");

ALTER TABLE "public"."user_play_log_blackjack"
  DROP CONSTRAINT "play_log_blackjack_pkey",
  ADD CONSTRAINT "play_log_blackjack_pkey" PRIMARY KEY ("lognumber", "agent_id", "user_id", "game_id", "room_type", "desk_id");
