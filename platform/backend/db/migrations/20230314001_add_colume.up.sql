...
COMMENT ON COLUMN "public"."game_users_stat"."tax" IS '抽水';

ALTER TABLE "public"."game_users_stat_hour" 
  ADD COLUMN "tax" numeric(20,4) NOT NULL DEFAULT 0;

COMMENT ON COLUMN "public"."game_users_stat_hour"."tax" IS '抽水';

DROP PROCEDURE IF EXISTS "public"."usp_game_users_stat"("_agent_id" int4, "_level_code" varchar, "_game_users_id" int4, "_de" float8, "_ya" float8, "_vaild_ya" float8, "_play_count" int4, "_big_win_count" int4, "_win_count" int4, "_lose_count" int4, "_last_bet_time" timestamptz);
