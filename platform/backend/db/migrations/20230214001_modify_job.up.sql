...
CREATE OR REPLACE VIEW "public"."v_user_play_log" AS
SELECT *
FROM
(
...
DROP MATERIALIZED VIEW IF EXISTS mv_cal_game_stat_hour;
DROP MATERIALIZED VIEW IF EXISTS mv_cal_game_stat_day;
DROP MATERIALIZED VIEW IF EXISTS mv_cal_game_stat_week;
DROP MATERIALIZED VIEW IF EXISTS mv_cal_game_stat_month;
