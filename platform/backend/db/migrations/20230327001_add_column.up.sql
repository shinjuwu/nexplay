-- 局紀錄新增bonus --
ALTER TABLE "public"."play_log_common" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."play_log_common"."bonus" IS '紅利';

-- 百家樂紀錄新增bonus --
ALTER TABLE "public"."user_play_log_baccarat" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_baccarat"."bonus" IS '紅利';

-- 番攤紀錄新增bonus --
ALTER TABLE "public"."user_play_log_fantan" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_fantan"."bonus" IS '紅利';

-- 色碟紀錄新增bonus --
ALTER TABLE "public"."user_play_log_colordisc" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_colordisc"."bonus" IS '紅利';

-- 魚蝦蟹紀錄新增bonus --
ALTER TABLE "public"."user_play_log_prawncrab" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_prawncrab"."bonus" IS '紅利';

-- 百人骰寶紀錄新增bonus --
ALTER TABLE "public"."user_play_log_hundredsicbo" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_hundredsicbo"."bonus" IS '紅利';

-- 21點紀錄新增bonus --
ALTER TABLE "public"."user_play_log_blackjack" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_blackjack"."bonus" IS '紅利';

-- 三公紀錄新增bonus --
ALTER TABLE "public"."user_play_log_sangong" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_sangong"."bonus" IS '紅利';

-- 牛牛紀錄新增bonus --
ALTER TABLE "public"."user_play_log_bullbull" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_bullbull"."bonus" IS '紅利';

-- 德州撲克紀錄新增bonus --
ALTER TABLE "public"."user_play_log_texas" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_texas"."bonus" IS '紅利';

-- 水果機紀錄新增bonus --
ALTER TABLE "public"."user_play_log_fruitslot" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_fruitslot"."bonus" IS '紅利';

-- 三國捕魚紀錄新增bonus --
ALTER TABLE "public"."user_play_log_rcfishing" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."user_play_log_rcfishing"."bonus" IS '紅利';

-- view_user_play_log新增bonus --
...
-- 統計玩家下注資料表新增bonus --
ALTER TABLE "public"."game_users_stat" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."game_users_stat"."bonus" IS '紅利';

-- 每小時統計玩家下注資料表新增bonus --
ALTER TABLE "public"."game_users_stat_hour" ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;
COMMENT ON COLUMN "public"."game_users_stat_hour"."bonus" IS '紅利';

-- 統計玩家usp下注資料新增bonus --
DROP PROCEDURE IF EXISTS "public"."usp_game_users_stat"("_agent_id" int4, "_level_code" varchar, "_game_users_id" int4, "_de" float8, "_ya" float8, "_vaild_ya" float8, "_tax" float8, "_play_count" int4, "_big_win_count" int4, "_win_count" int4, "_lose_count" int4, "_last_bet_time" timestamptz);
...
ALTER TABLE IF EXISTS "public"."agent_game_ratio_stat"
  ADD COLUMN "tax" numeric(20,4) NOT NULL DEFAULT 0,
  ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS "public"."agent_game_ratio_stat_202302"
  ADD COLUMN "tax" numeric(20,4) NOT NULL DEFAULT 0,
  ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS "public"."agent_game_ratio_stat_202303"
  ADD COLUMN "tax" numeric(20,4) NOT NULL DEFAULT 0,
  ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;

ALTER TABLE IF EXISTS "public"."agent_game_ratio_stat_202304"
  ADD COLUMN "tax" numeric(20,4) NOT NULL DEFAULT 0,
  ADD COLUMN "bonus" numeric(20,4) NOT NULL DEFAULT 0;

-- 代理遊戲平台營收統計總表新增tax及bonus --
...
-- 代理遊戲平台營收統計usp新增tax及bonus --
DROP PROCEDURE IF EXISTS "public"."usp_insert_agent_game_ratio_stat"("_id" varchar, "_level_code" varchar, "_agent_id" int4, "_game_id" int4, "_game_type" int4, "_room_type" int4, "_de" numeric, "_ya" numeric, "_vaild_ya" numeric, "_play_count" int4, "_bet_time" timestamptz);
	...
	EXECUTE 'INSERT INTO "public"."'||_stat_table_name||'"("id", "level_code", "agent_id", "game_id", "game_type", "room_type", "de", "ya", "vaild_ya", "tax", "bonus", "play_count", "update_time")
			...
			UPDATE SET 	
				...
				update_time = EXCLUDED.update_time
						;'
				USING
					_id, _level_code, _agent_id, _game_id, _game_type, _room_type, _de, _ya, _vaild_ya, _tax, _bonus, 1, now();
	...
	EXECUTE 'INSERT INTO "public"."'||_stat_month_table_name||'"("log_time", "id", "level_code", "agent_id", "game_id", "game_type", "room_type", "de", "ya", "vaild_ya", "tax", "bonus", "play_count", "update_time")
            ...
            tax = '||_stat_month_table_name||'.tax + EXCLUDED.tax,
				...
				update_time = EXCLUDED.update_time
						;'
				USING
					_log_time, _id, _level_code, _agent_id, _game_id, _game_type, _room_type, _de, _ya, _vaild_ya, _tax, _bonus, 1, now();
	
END$BODY$
  LANGUAGE plpgsql;

-- mv_cal_game_stat_hour新增bonus --
