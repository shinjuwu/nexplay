CREATE FUNCTION "public"."udf_create_agent"("_agent_name" varchar, "_agent_code" varchar,
    ...
    "_agent_aes_key" varchar, "_agent_md5_key" varchar, "_agent_ip_whitelist" jsonb,
    "_agent_creator" varchar, "_agent_commission" int4, "_agent_cooperation" int4,
    "_agent_top_agent_id" int4, "_agent_is_top_agent" bool, "_admin_user_username" varchar,
    "_admin_user_password" varchar, "_admin_user_nickname" varchar, "_admin_user_role" uuid,
    "_admin_user_info" varchar, "_admin_user_account_type" int4, "_admin_user_is_readonly" int4)
    RETURNS json AS $$
DECLARE
    "ret_agent_id" int4;
    ...
    "ret_agent_coin_supply_setting" jsonb;
...
BEGIN
    INSERT INTO "public"."agent" ("name", "code", "level_code", "info", "secret_key",
        ...
        RETURNING "id", "name", "code", "secret_key", "aes_key", "md5_key", "commission", "info",
            ...
            "cooperation", "coin_limit", "coin_use", "coin_supply_setting", "ip_whitelist", "creator" INTO
            ...
            "ret_agent_coin_supply_setting", "ret_agent_ip_whitelist", "ret_agent_creator";
    ...
    RETURN json_build_object(
        'agent', json_build_object(
            ...
            'coin_supply_setting', "ret_agent_coin_supply_setting",
...
CREATE FUNCTION "public"."udf_update_agent"("_agent_id" int4, "_agent_name" varchar,
    ...
    "_admin_user_info" varchar, "_admin_user_is_enabled" int4)
    RETURNS json AS $$
DECLARE
    "ret_agent_update_time" timestamp;
    "ret_admin_user" json;
BEGIN
    UPDATE "public"."agent"
            SET "name" = "_agent_name",
                ...
                "cooperation" = "_agent_cooperation",
                "coin_supply_setting" = "_agent_coin_supply_setting",
                "update_time" = now()
            WHERE "id" = "_agent_id"
