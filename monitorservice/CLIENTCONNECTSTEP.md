# order service connect information
...
```
scheme: http/https://
api path: /api/v1/notify/getmonitorserviceconnInfo
method: GET
verify: jwt
```
...
```
{
  ...
  "data": {
    ...
    "path": "/monitorservice.api/v1/",
    "scheme": "http",
    "api_key": "defaultkey",
    "ws_conn_path": "/monitorservice.ws"
  }
}
```
* channel: 聊天頻道(平台碼)
...
```
scheme: http/https://
api path: /monitorservice.api/v1/login
method: POST
verify: BasicAuth
	BasicAuth username: /api/v1/notify/getmonitorserviceconnInfo 取得之 api_key
	BasicAuth password: ""
```
...
```
scheme: ws://
api path: 127.0.0.1:8986/monitorservice.ws
verify: token
```
...
```
* token: monitorservice.api/v1/login 取得之token
