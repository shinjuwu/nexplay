...
type AppConfig struct {
	...
	UpdateRedisData    bool   `yaml:"update_redis_data" json:"update_redis_data"`
	...
	LoadRecordChannel  bool   `yaml:"load_record_channel" json:"load_record_channel"`
	LoadCasinoChannel  bool   `yaml:"load_casino_channel" json:"load_casino_channel"`
...
func NewAppConfig() *AppConfig {
	return &AppConfig{
		...
		LoadRecordChannel:  false,
		LoadCasinoChannel:  false,
