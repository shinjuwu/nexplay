...
BEGIN
    ...
    SELECT "public"."udf_create_agent_games" ("ret_agent_id") INTO "ret_agent_games";

    SELECT "public"."udf_create_agent_game_rooms" ("ret_agent_id") INTO "ret_agent_game_rooms";
