...
VALUES
  ...
  (100244, '此接口用來取得當前 job 的資訊清單', '/api/v1/cal/getjobshedulerlist', true, '後台使用',true),
...
SET
  "permission" = '{"list":[100200,100201,100202,100203,100204,100205,100206,100207,100208,100209,100210,100211,100212,100213,100214,100215,100225,100226,100227,100228,100229,100230,100231,100232,100233,100236,100237,100238,100239,100240,100241,100242,100245,100246,100247,100248,100249,100250,100251,100252,100255]}'
WHERE
  "account_type" = 1;
...
UPDATE
  "public"."agent_permission"
SET
  "permission" = '{"list":[100200,100201,100202,100203,100204,100205,100206,100207,100208,100209,100210,100211,100212,100213,100230,100231,100232,100233,100236,100237,100238,100239,100240,100241,100242,100245,100246,100247,100248,100249,100250,100251,100252,100253,100254,100255]}'
WHERE
  "account_type" = 2;
...
UPDATE
  "public"."agent_permission"
SET
  "permission" = '{"list":[100201,100202,100203,100204,100205,100206,100207,100208,100209,100210,100211,100212,100213,100230,100231,100232,100233,100236,100237,100238,100239,100240,100241,100242,100245,100246,100247,100248,100249,100252,100253,100254,100255]}'
WHERE
  "account_type" = 3;
