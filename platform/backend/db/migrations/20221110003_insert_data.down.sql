DELETE FROM "public"."permission_list" WHERE "feature_code" IN (100250, 20051);
...
FROM (
    ...
    WHERE "ag2"."agent_id" = -1 AND "ag2"."account_type" IN (1, 2) AND "ag2ple"::int NOT IN (100250, 100251)
    GROUP BY "ag2"."id"
) AS "ag3"
WHERE "ag1"."id" = "ag3"."id";
