...
func main() {
	...
	startupLogger.Info("chat service starting")
	...
	apiServer := api.NewApiServer(runtimeLogger, db.GetDefaultDB(), yamlConfig, sessionManager, pipeline)
