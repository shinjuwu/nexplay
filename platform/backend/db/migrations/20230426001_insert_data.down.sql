DELETE FROM "public"."permission_list" WHERE feature_code IN (100294, 100295);
...
FROM (
    ...
    WHERE "ag2ple"::int NOT IN (100294, 100295)
    GROUP BY "ag2"."id"
) AS "ag3"
WHERE "ag1"."id" = "ag3"."id";

ALTER TABLE "public"."exchange_data" RENAME COLUMN "to_coin" TO "to_cny";
