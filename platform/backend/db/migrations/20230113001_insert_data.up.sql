...
BEGIN
	...
	SELECT 
		"id", "username", is_enabled, false  into _user_id, _username, _is_enabled, _is_new
	FROM
		"public"."game_users" 
	WHERE
	...
	IF NOT FOUND THEN
		...
		RETURNING "id", "username", "is_enabled", true into _user_id, _username, _is_enabled, _is_new
		;
