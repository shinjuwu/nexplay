  ...
  <ToggleHeader>
    <template #default="{ show }">
      ...
      <div class="text-danger my-2 text-right">
        <span :class="[sumWinLoseScore >= 0 ? 'text-danger' : 'text-success']">
          {{ t('fmtTextPlayerTotalWinLoseScore', [numberToStr(sumWinLoseScore)]) }},
        </span>
        <span>
          {{ t('fmtTextAvgDeductTaxRTP', [`${numberToStr(avgDeductTaxRtp)}%`]) }}
        </span>
      </div>
            ...
            <table class="tbl tbl-hover">
              <thead>
                <tr>
                  ...
                  <PageTableSortableTh column="score" :is-sort-icon-active="isSortIconActive" @sorting="sorting">
...
import { usePlayerLog } from '@/base/composable/reportManagement/playerLog/usePlayerLog'
