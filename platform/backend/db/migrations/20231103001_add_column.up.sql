ALTER TABLE "public"."wallet_ledger" 
  ADD COLUMN "api_url" varchar(512) NOT NULL DEFAULT ''::character varying,
  ADD COLUMN "api_response" jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN "public"."wallet_ledger"."api_url" IS 'single wallet request api url';
COMMENT ON COLUMN "public"."wallet_ledger"."api_response" IS 'single wallet api repsonse';

ALTER TABLE "public"."agent" 
  ADD COLUMN "wallet_type" int2 NOT NULL DEFAULT 0,
  ADD COLUMN "wallet_conninfo" jsonb NOT NULL DEFAULT '{}'::jsonb;

COMMENT ON COLUMN "public"."agent"."wallet_type" IS '錢包模式(轉帳錢包[預設]:0、單一錢包:1)';
COMMENT ON COLUMN "public"."agent"."wallet_conninfo" IS '錢包api位置';

DROP FUNCTION "public"."udf_create_agent"("_agent_name" varchar, "_agent_code" varchar, "_agent_level_code" varchar, "_agent_info" varchar, "_agent_secret_key" varchar, "_agent_aes_key" varchar, "_agent_md5_key" varchar, "_agent_currency" varchar, "_agent_ip_whitelist" jsonb, "_agent_creator" varchar, "_agent_commission" int4, "_agent_cooperation" int4, "_agent_top_agent_id" int4, "_agent_is_top_agent" bool, "_admin_user_username" varchar, "_admin_user_password" varchar, "_admin_user_nickname" varchar, "_admin_user_role" uuid, "_admin_user_info" varchar, "_admin_user_account_type" int4, "_admin_user_is_readonly" int4);

CREATE OR REPLACE FUNCTION "public"."udf_create_agent"("_agent_name" varchar, "_agent_code" varchar, "_agent_level_code" varchar, "_agent_info" varchar, "_agent_secret_key" varchar, "_agent_aes_key" varchar, "_agent_md5_key" varchar, "_agent_currency" varchar, "_agent_ip_whitelist" jsonb, "_agent_creator" varchar, "_agent_commission" int4, "_agent_cooperation" int4, "_agent_top_agent_id" int4, "_agent_is_top_agent" bool, "_agent_wallet_type" int2, "_agent_wallet_conninfo" varchar, "_admin_user_username" varchar, "_admin_user_password" varchar, "_admin_user_nickname" varchar, "_admin_user_role" uuid, "_admin_user_info" varchar, "_admin_user_account_type" int4, "_admin_user_is_readonly" int4)
...
DECLARE
  ...
  "ret_agent_creator" varchar;
	...
	"ret_agent_wallet_conninfo" varchar;
