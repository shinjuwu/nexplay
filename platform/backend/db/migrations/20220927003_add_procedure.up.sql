CREATE PROCEDURE "public"."procedure_update_agent_game_state_by_agent"(target_agent_id int, target_game_id int, agent_game_state int)
  LANGUAGE plpgsql AS
$$
BEGIN
...
CREATE PROCEDURE "public"."procedure_update_agent_game_room_state_by_agent"(target_agent_id int, target_game_room_id int, agent_game_room_state int)
  LANGUAGE plpgsql AS
$$
BEGIN
